...
export default {
  pages: {
    key: 'title',
    data: [
      { title: 'Главная', route: { name: 'dashboard' }, icon: 'HomeIcon', isBookmarked: false },
      { title: 'Топливные карты', route: { name: 'cards' }, icon: 'CreditCardIcon', isBookmarked: false },
      { title: 'Транзакции', route: { name: 'transactions' }, icon: 'ListIcon', isBookmarked: false },
      { title: 'Отчёты и графики', route: { name: 'report' }, icon: 'TrendingUpIcon', isBookmarked: false },
      // { title: 'Документы', route: { name: 'documents' }, icon: 'ArchiveIcon', isBookmarked: false },
      { title: 'Заявки', route: { name: 'requests' }, icon: 'CheckSquareIcon', isBookmarked: false },
      { title: 'Заказать счет', route: { name: 'bill' }, icon: 'ClipboardIcon', isBookmarked: false },
